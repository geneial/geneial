...
int main(int argc, char **argv)
{
    ...
    MultiValueBuilderSettings<int, double> *builderSettings = new MultiValueBuilderSettings<int, double>(evaluator,
            charsPerFigure, 128, 32);

    MultiIntValueChromosomeFactory<double> *chromosomeFactory = new MultiIntValueChromosomeFactory<double>(
            builderSettings);
    ...
    BaseMutationOperation<double> *mutationOperation = new UniformMutationOperation<int, double>(mutationSettings,
            mutationChoosingOperation, builderSettings, chromosomeFactory);
...
//	BaseSelectionOperation<double> *selectionOperation = new RouletteWheelSelection<double>(selectionSettings);
    ...
    BaseFitnessProcessingStrategy<double> *fitnessProcessingStrategy =
            new MultiThreadedFitnessProcessingStrategy<double>(2);
