...
BOOST_AUTO_TEST_SUITE( CombinedCriterion )
BOOST_AUTO_TEST_SUITE_END()


BOOST_AUTO_TEST_SUITE( NegationDecorator )
BOOST_AUTO_TEST_SUITE_END()


BOOST_AUTO_TEST_SUITE( ConsecutiveDecorator )
BOOST_AUTO_TEST_SUITE_END()
...
BOOST_AUTO_TEST_SUITE( FitnessValueDeltaCriterion )
BOOST_AUTO_TEST_SUITE_END()


BOOST_AUTO_TEST_SUITE( FitnessValueReachedCriterion )
BOOST_AUTO_TEST_SUITE_END()


BOOST_AUTO_TEST_SUITE( PopulationUnchangedCriterion )
BOOST_AUTO_TEST_SUITE_END()


BOOST_AUTO_TEST_SUITE( TrailingStopCriterion )
BOOST_AUTO_TEST_SUITE_END()


BOOST_AUTO_TEST_SUITE( FixPointCriterion )
BOOST_AUTO_TEST_SUITE_END()
