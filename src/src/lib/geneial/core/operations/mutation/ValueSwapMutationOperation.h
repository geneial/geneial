...
class ValueSwapMutationOperation: public MultiValueChromosomeMutationOperation<VALUE_TYPE,FITNESS_TYPE>,
                                  public virtual EnableMakeShared<ValueSwapMutationOperation<VALUE_TYPE,FITNESS_TYPE>>
{
protected:
    /*
     * ValueSwapMutationOperation Swaps two entries of a chromosome
     */
	ValueSwapMutationOperation(
...
public:
    ...
    virtual ~ValueSwapMutationOperation()
    {
    }
    ...
    public:
        ...
        {
            return std::move(
            		ValueSwapMutationOperation<VALUE_TYPE, FITNESS_TYPE>::makeShared
                     (
                        this->_settings,
...
#include <geneial/core/operations/mutation/ValueSwapMutationOperation.hpp>
