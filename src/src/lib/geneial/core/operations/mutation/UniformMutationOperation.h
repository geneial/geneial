...
public:
	...
	virtual typename BaseMutationOperation<FITNESS_TYPE>::mutation_result_set doMutate(double min, double max, typename BaseChromosome<FITNESS_TYPE>::ptr mutant);
